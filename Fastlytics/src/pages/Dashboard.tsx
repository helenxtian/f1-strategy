...
const Dashboard = () => {
  ...
  // Build dashboard race cards from schedule only
            ...
            <section ref={teamsRef}>
              ...
              >
                ...
                {isLoadingTeams ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    {(Array.isArray(teamStandings) ? teamStandings : []).slice(0, 4).map((team, index) => (
                      <motion.div
            ...
            <section ref={driversRef}>
              ...
              >
                ...
                {isLoadingDrivers ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    {(Array.isArray(driverStandings) ? driverStandings : []).slice(0, 4).map((driver, index) => (
                      <motion.div
                        key={driver.code}
                        initial="hidden"
                        animate={isDriversInView ? "visible" : "hidden"}
          ...
          <aside className="lg:col-span-1 space-y-6" ref={racesRef}>
            ...
            >
              ...
              {isLoadingSchedule ? (
                ...
                >
                  No race calendar available for {selectedYear}.
                </motion.p>
              )}
            </motion.div>
          </aside>
